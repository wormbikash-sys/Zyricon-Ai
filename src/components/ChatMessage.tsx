      ...
      <div className={`max-w-3xl mx-auto flex gap-3 min-w-0 ${isUser ? 'justify-end' : 'justify-start'}`}>
        ...
        {!isUser && (
          <div className="shrink-0 mt-0.5">
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-gradient-to-tr from-purple-600 to-indigo-500 p-[1px] flex items-center justify-center text-white shadow-md shadow-purple-600/20">
        ...
        <div className={`space-y-1 min-w-0 ${isUser ? 'max-w-[90%] sm:max-w-[80%]' : 'flex-1 max-w-full'}`}>
          ...
          {isUser ? (
            ...
            /* Assistant Message Body (No giant card border) */
          ...
          {isStreaming && (
            <div className="flex items-center gap-1.5 text-xs text-purple-300 font-medium py-1 animate-pulse">
              <Sparkles className="w-3.5 h-3.5 animate-spin" />
              <span>Zyricon AI is thinking...</span>
            </div>
          )}
